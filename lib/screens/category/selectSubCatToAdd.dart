...
class SelectSubCatToAddProd extends StatefulWidget {
  final String title;
  final String categoryId;
  final String categoryName;
  final String categoryImg;
  final List subCategory;
  SelectSubCatToAddProd(this.title, this.categoryId, this.categoryName,
      this.categoryImg, this.subCategory);

  @override
  State<StatefulWidget> createState() => _SelectSubCatToAddProdState(this.title,
      this.categoryId, this.categoryName, this.categoryImg, this.subCategory);
}

class _SelectSubCatToAddProdState extends State<SelectSubCatToAddProd> {
  String title;
  String categoryId;
  String categoryName;
  String categoryImg;
  ...
  _SelectSubCatToAddProdState(this.title, this.categoryId, this.categoryName,
      this.categoryImg, this.subCategory);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text("Choose to add type", style: Palette.whiteTitle2),
  ...
  Widget _subCategoryListView() {
    ...
    //           context,
    //           MaterialPageRoute(
    //               builder: (context) => AddProductSOne(title, categoryId, categoryName,
    //                   categoryImg, subCatId, subCatName))),
    //       leading: Image(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => AddProductSOne(title, categoryId,
                      categoryName, categoryImg, subCatId, subCatName))),
          child: Container(
