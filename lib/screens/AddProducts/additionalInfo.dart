...
class AdditionalInfo extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AdditionalInfoState(
        this.categoryId,
        this.categoryName,
        this.categoryImg,
        this.subCatId,
...
class _AdditionalInfoState extends State<AdditionalInfo> {
  ...
  TextEditingController _onFloorController =
      TextEditingController(); //custom[35]
  TextEditingController _supAreaController =
      TextEditingController(); //custom[27]
  TextEditingController _carpetAreaController =
      TextEditingController(); //custom[28]
  TextEditingController _totalFloorController =
      TextEditingController(); //custom[34]
  ...
  Future<void> _fetchData() async {
    final String url =
        "${Constants.ADDINOAL_INFO}&catid=$categoryId&subcatid=$subCatId";
